...
document.write('<tr style="font:bold 13px Arial; width: 140px" onselectstart="return false"><td style="cursor:pointer;width:20px;font-size:15px" onclick="upmonth(-1)">&laquo;</td><td colspan="5" id="mns" align="center"></td><td align="right" style="cursor:pointer;font-size:15px" onclick="upmonth(1)">&raquo;</td></tr>');
